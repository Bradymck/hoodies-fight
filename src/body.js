...
// Shifted 10px up from the raw sampled points (below) - at the raw anchor
// the collar covered most of the head, leaving only a sliver visible.
const HEAD_ANCHORS = {
  idle: [{"x":34.8,"y":-10},{"x":34.8,"y":-10},{"x":34.8,"y":-10},{"x":35.3,"y":-10},{"x":35.8,"y":-10},{"x":35.8,"y":-10},{"x":35.5,"y":-10},{"x":34.8,"y":-10}],
  walk: [{"x":37.9,"y":3},{"x":39.5,"y":2},{"x":38.4,"y":1},{"x":39.1,"y":0},{"x":37.5,"y":2},{"x":37.9,"y":3},{"x":39.2,"y":1},{"x":38.8,"y":0}],
  attack: [{"x":39.0,"y":-1},{"x":38.3,"y":-2},{"x":37.9,"y":-1},{"x":34.0,"y":1},{"x":30.3,"y":-2},{"x":44.8,"y":-3},{"x":46.8,"y":0},{"x":44.3,"y":-1}],
  kick: [{"x":39.0,"y":-1},{"x":38.1,"y":0},{"x":36.8,"y":0},{"x":30.8,"y":0},{"x":40.5,"y":-2},{"x":37.7,"y":-5},{"x":42.7,"y":2},{"x":39.3,"y":-1}],
  jump: [{"x":39.0,"y":-1},{"x":38.0,"y":-1},{"x":38.6,"y":3},{"x":39.9,"y":8},{"x":42.3,"y":-6},{"x":38.5,"y":-8},{"x":37.9,"y":-5},{"x":38.3,"y":0}],
  hurt: [{"x":34.8,"y":-10},{"x":34.7,"y":-10},{"x":34.5,"y":-10},{"x":35.0,"y":-9},{"x":36.0,"y":-10},{"x":35.7,"y":-9},{"x":34.5,"y":-10},{"x":34.8,"y":-10}],
};
